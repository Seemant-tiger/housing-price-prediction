...
from yellowbrick.target import FeatureCorrelation as FC
...
class MutualInformation:
    ...
    def __init__(self, is_classification):
        ...
        self.model = FC(method=method, sort=True)
    ...
    def get_plot_data(self):
        ...
        data = pd.DataFrame(
            self.model.scores_, index=[self.X.columns[i] for i in self.model.features_]
        )
        return data
